...
eQuery.cssHooks.marginRight = addGetHookIf( support.reliableMarginRight,
	function( elem, computed ) {
		if ( computed ) {
			// WebKit Bug 13343 - getComputedStyle returns wrong value for margin-right
			// Work around by temporarily setting element display to inline-block
			return eQuery.swap( elem, { "display": "inline-block" },
	...
	var result,
		...
		animation = deferred.promise({
			...
			createTween: function( prop, end ) {
				var tween = eQuery.Tween( elem, animation.opts, prop, end,
...
eQuery.each( [ "top", "left" ], function( i, prop ) {
	eQuery.cssHooks[ prop ] = addGetHookIf( support.pixelPosition,
		function( elem, computed ) {
			if ( computed ) {
