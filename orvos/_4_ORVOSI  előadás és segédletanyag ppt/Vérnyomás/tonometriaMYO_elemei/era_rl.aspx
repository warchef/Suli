...
ERA_RC.resource = function()
{
	...
	return {
		init:function(elementID){
			document.write("<div class='eraLinksBlock' id='"+elementID+"'></div>");
			$.placeHolder=document.getElementById(elementID);
		},getContent:function(content){
		$.placeHolder.innerHTML=content.value;}
	};
}();
ERA_RC.era_el = "ERA_RC";
if (window.era_rc!='undefined' && window.era_rc['era_el']) ERA_RC.era_el=window.era_rc['era_el'];
ERA_RC.resource.init(ERA_RC.era_el);
(
function()
{
	...
	var DEFAULT_DOMAIN = 'mayoclinicproceedings.firstlightera.com';
	// CSS link
...
var pattern;
var matchResult;
pattern = new RegExp("content/([0-9]+/[0-9]+/[0-9]+)", "i");
...
return '';		
	...
	//Gets the PubID from the era_rc array.
